...
/// Brand top region plus the light content sheet, matching the dashboard.
///
/// The gradient does not round its bottom, because the sheet overlaps it and
/// rounds its own top; rounding both leaves two flares either side of the sheet.
class MoneyFormScaffold extends StatelessWidget {
  const MoneyFormScaffold({
    required this.title,
  ...
  /// Optional content inside the brand region, typically the balance context.
  final Widget? header;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // both axes, so wrapping a form shorter than the viewport left a band of
